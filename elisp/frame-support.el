;;; Basic setup for an Emacs windows look...
...
;; Now set up key bindings and the frame parameters.
(if window-system
    (frame-initialize))
      
(provide 'frame-support)
